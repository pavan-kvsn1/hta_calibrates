...
describe('StatusBadge', () => {
  describe('renders correct label for each status', () => {
    ...
    it('renders Pending HoD Review status', () => {
      render(<StatusBadge status="PENDING_HOD_REVIEW" />)
      expect(screen.getByText('Pending HoD Review')).toBeInTheDocument()
    })
  ...
  describe('styling', () => {
    ...
    it('applies correct colors for PENDING_HOD_REVIEW status', () => {
      render(<StatusBadge status="PENDING_HOD_REVIEW" />)
      const badge = screen.getByText('Pending HoD Review')
