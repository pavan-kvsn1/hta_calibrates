  ...
  return (
    <div className="space-y-4">
      ...
      <ImageGalleryModal
        ...
        onClose={() => setUucImagesModal((prev) => ({ ...prev, isOpen: false }))}
      ...
      <ImageGalleryModal
        ...
        onClose={() => setMasterImagesModal((prev) => ({ ...prev, isOpen: false }))}
      ...
      <ReadingImagesViewModal
        ...
        onClose={() => setReadingImagesModal((prev) => ({ ...prev, isOpen: false }))}
